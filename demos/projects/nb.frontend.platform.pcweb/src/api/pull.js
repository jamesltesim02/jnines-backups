 ...
 *    {
 *      sportID: 体育类别id
 *      matchState: 比赛状态 null: 所有, 1: 滚球, 0: 早盘
 *    }
 */
 ...
 * 按体育项统计比赛数
 */
export const matchCountBySport = () => axios.post('match/matchCountBySport');
 ...
 *    }
 */
export const countByTid = params => axios.post('match/countByTid', params);
