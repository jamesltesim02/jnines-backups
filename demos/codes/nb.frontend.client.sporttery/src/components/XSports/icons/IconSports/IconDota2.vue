<template>
<svg width=".25rem" height=".24rem" viewBox="0 0 25 24">
  <defs>
    <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="dota-color-1">
      <stop stop-color="#BFBFBF" stop-opacity="0.7" offset="0%"></stop>
      <stop stop-color="#8A8A8A" stop-opacity="0.7" offset="100%"></stop>
    </linearGradient>
    <linearGradient x1="24.1422287%" y1="3.88141257%" x2="99.2251648%" y2="99.0182144%" id="dota-color-2">
      <stop stop-color="#E5EBF1" stop-opacity="0.4" offset="0%"></stop>
      <stop stop-color="#B8BCBF" stop-opacity="0.24" offset="100%"></stop>
    </linearGradient>
  </defs>
  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
    <g class="main-fill" transform="translate(-255, -230)" :fill="`url(#dota-color-${/blue/i.test(theme) ? 2 : 1})`" >
