...
class BetStandledAll extends Component{
        ...
        return(
            <div className="nb_Overalltabelbox">
                ...
                <div className="nb_OverallItemspagebox">
                    {options.map((item,index)=><BetItemContainer sno={sno} oid={item.oid} key={item.oid}><BetStandle_all_single {...item} {...this.props} sno={sno}/></BetItemContainer>)}
                </div>
...
class BetStandledHalf extends Component{
    render(){
        let {options,sno}=this.props;
        return(
            <div className="nb_Overalltabelbox">
                ...
                <div className="nb_OverallItemspagebox">
                    {options.map((item,index)=><BetItemContainer sno={sno} oid={item.oid} key={item.oid}><BetStandle_all_single {...item}/></BetItemContainer>)}
                </div>
...
export {BetStandledAll,BetStandledHalf}