import member from './modules/member.zh-CN.message';
import otherGame from './modules/otherGame.en-US.message';
...
export default {
  ...
  market: {
    ...
    13: {
      ...
      '1_0_18': 'Total Points',
      /** 第一局大小 */
      '1_51_18': 'Set 1 Total Points',
      /** 第二局大小 */
      '1_52_18': 'Set 2 Total Points',
      /** 第三局大小 */
      '1_53_18': 'Set 3 Total Points',
      /** 第四局大小 */
      '1_54_18': 'Set 4 Total Points',
      /** 第五局大小 */
      '1_55_18': 'Set 5 Total Points',
      /** 单双 */
      '1_0_26': 'Odd/Even (Sets)',
      /** 第一局单双 */
      '1_51_26': 'Set 1 Odd/Even (Sets)',
      /** 第二局单双 */
      '1_52_26': 'Set 2 Odd/Even (Sets)',
      /** 第三局单双 */
      '1_53_26': 'Set 3 Odd/Even (Sets)',
      /** 第四局单双 */
      '1_54_26': 'Set 4 Odd/Even (Sets)',
      /** 第五局单双 */
      '1_55_26': 'Set 5 Odd/Even (Sets)',
      /** 胜负 */
      '1_0_186': 'To Win',
      /** 第一局胜负 */
  ...
  match: {
    ...
    select: 'Featured',
    /** 动画直播(比赛详情切换按钮) */
    media_lmt: 'Live Flash',
    /** 视频直播(比赛详情切换按钮) */
    media_video: 'Live Stream',
    /** 共{count}场比赛 */
    total_matchs: 'Total {count} Matches',
    /** 赛事 (列表标题) */
    list_title_tour: 'Tournament',
    /** 赛事 (列表标题) */
    list_title_versus: 'Match',
    /** 未找到相关比赛 (详情) */
    ...
    games: 'Total Games',
    /** 添加到收藏 */
    add_favorite: 'Add to My Games',
    /** 已添加到收藏 */
    favorited: 'My Games Added',
    /** 详情注单数量 */
    order_count: 'Bet Slip ({count})',
    /** 暂无玩法 */
    ...
    /** 按联赛排序 */
    tour_sort: 'Sort by League',
    /** 正在直播 */
    live_block_title: 'Live Streaming',
    /** 进球啦! */
    goal_notify: 'Goal!!!!!!!!!!!!',
    /** {count}场赛事 (搜索框联赛对应的赛事数量) */
    serch_countoftour: '{count}场赛事',
    /** 已有新的滚球比赛, 点击立即更新 */
    inplay_updated: 'New In-Play Match Available, Click to Refresh',
    /** 继续看直播 */
  ...
  settings: {
    ...
    savetip: 'Any change done must click SAVE to be effective',
    /** 其他设置 */
    others: 'Others',
    /** 开启进球提示音 */
  ...
  bet: {
    ...
    /** 自动接受所有赔率变化 */
    accept_all: 'Accept All Odds Changes',
    /** 自动接受更高赔率变化 */
    ...
    /** 实际盘口和赔率以最终受注结果为准 */
    odds_tips: '* Actual market and odds is determined by the bet slip accepted.',
    /** 查看更多注单 */
  ...
  common: {
    ...
    copyright: '© 2020 J9SPORTS Copyrighted | 18+',
    /** 网络请求错误,请稍后再试! */
  ...
  pages: {
    ...
    euro2020: 'EURO2020',
    /** 欧洲杯联赛名 */
    euro2020_tourname: 'UEFA Euro 2020',
    /** 游戏额度 */
    game_credit: 'Credit',
    /** 立即登录 */
    signin: 'Login Now',
    /** 免费注册 */
    signup: 'Free Register',
    /** 存款 */
    deposit: 'Deposit',
    /** 退出 */
    quit: 'Logout',
    /** 退出成功 */
    quit_sucecss: 'Logout Successful!',
    /** 玩法规则 */
    rules: 'Game Rules',
    /** 特别说明 */
    ...
    my_orders: 'My Bets',
    /** 公告列表 */
    annou_list: 'Notice List',
    /** 公告详情 */
    annou_detail: 'Notice Detail',
    /** 公告标题 */
    annou_title: 'Notice Title',
    /** 公告时间 */
    annou_time: 'Notice Time',
    /** 更多... */
    annou_more: 'More...',
    /** 暂无公告内容 */
    annou_none: 'No Notice at the Moment',
    /** 近期开赛 */
    soon_list: 'Starting Soon',
    /** 最新优惠 */
    promo_title: 'Latest Promo',
    /** 优惠提示 */
    promo_tip: 'Please keep an eye here as we will launch new promotions from time to time',
    /** 本活动长期有效 */
    promo_forever: 'Effective All the Time',
    /** 活动倒计时 */
    promo_countdown: 'Ending in：{days}Days {hours}Hours {minutes}Mins {seconds}Secs',
    /** 收藏切换提示 */
