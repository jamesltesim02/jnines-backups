...
import otherGame from './modules/otherGame.zh-CN.message'
...
export default {
  ...
  market: {
    ...
    99: {
      ...
      // 待确认 摧毁第一炮塔第{y}层
      ...makeEsportMapMarkets('9027', '摧毁第一炮塔第{y}层'),
      // 第x图击杀巨龙总数让分
  ...
  bet: {
    ...
    betting: '投注受理中...',
    /** 当前限额{min} ~ {max}元 */
    amount_limit: '当前限额{min} ~ {max}',
    /** 自动接受所有赔率变化 */
    accept_all: '接受所有赔率变化',
    /** 自动接受更高赔率变化 */
    accept_better: '接受更佳赔率变化',
    /** 请输入投注金额 */
