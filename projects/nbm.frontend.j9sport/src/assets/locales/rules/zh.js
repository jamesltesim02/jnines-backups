export default {
  title: `投注规则`,
  content: `某些赛事和赌盘有不同的规则，这些规则列于本网站有关特定赛事或赌盘/投注类型的《特别赛事/赌盘投注规则》中。 下述内容为适用于所有赛事和赌盘/投注类型的一般规则，必须完全遵守。 在适用的情况下，本公司网站公布的《条款和条件》中所列规定与定义应当适用于本《投注规则与规定》。`,
  children: [
    {
      content: `一般投注规则与规定`,
      children: [
        {
          ...
          children: [
            ...
            {
              content: `在出现以下任何情形时，本公司可全权在不提前通知的前提下决定取消或宣布投注无效或暂停用户账号：`,
              children: [
                `投注细节不完整或错误；`,
                `投注超出公司所规定的限额；`,
                `以违反公司规则方式投注；`,
            ...
            `本公司保留暂停和/或随时关闭客户账户的权利，如果公司认为客户违反任何适用的规则和规章，或欺骗、黑客入侵、攻击、操纵或破坏了正常的投注程序，或如果该客户从事洗钱或其他非法活动，或者该客户低于其所在管辖区或实际区域参与赌博的法定年龄。一旦由于上述原因关闭客户账户，包括客户账户余额在内的所有奖金和/或支出都将没收。`,
        ...
        },
        {
          ...
          children: [
            ...
            `如果选定赛事或赛程被取消而注单已实时兑现，除了无条件决定投注结果的注单外，注单的实时兑现将被撤回。注单实时兑现的金额将从客户的账户中扣除，且原始投注金额将退还给客户。`,
            `注单实时兑现的金额将在合理的时间内计入客户的账户。`,
        ...
        },
        {
          ...
          children: [
            ...
            `所有最高派彩限额也针对任何群组客户，或一个组织团体/集团投注予相同的串关组合，包括通过不同的账号下注予相同系列组合，以及同一范围里的价位。`,
