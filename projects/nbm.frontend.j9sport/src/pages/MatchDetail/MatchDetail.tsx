...
import VideoInfo from '../../components/matchs/DetailContent/InfoBox/MediaBox/Video'
...
function MatchDetail (
  ...
  const handleStreamHolding = () => {
    ...
    streamHolderRef.current?.appendChild(
      document.querySelector('.video iframe') as HTMLIFrameElement
    )
  };
  ...
  React.useEffect(
    () => {
      ...
      pull.getTicketByMatch({matchId: mid, userName: memberStore.username}).then(
