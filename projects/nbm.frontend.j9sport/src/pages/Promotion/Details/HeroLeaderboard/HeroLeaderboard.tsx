...
import BannerImage from './images/pc-banner@2x.png';
import Medal1Image from './images/pc-medal-1.svg';
import Medal2Image from './images/pc-medal-2.svg';
import Medal3Image from './images/pc-medal-3.svg';
import BoxNum1Image from './images/pc-box-num-1.svg';
import BoxNum2Image from './images/pc-box-num-2.svg';
import BoxNum3Image from './images/pc-box-num-3.svg';
                ...
                <tbody>
                {
                  data.profitIndex.map((item, index) => (
                    <tr>
                      ...
                      <td>
                        {item.ticketCount > 30 ? '完成' : item.ticketCount}
                      </td>
                    </tr>
                  ))
                }
