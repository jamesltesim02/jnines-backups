...
import { ListMarket, LIST_MARKETS, MatchState, GroupOfMarket, MarketCategory, MarketStage, MediaType, PushNt, Sports } from '../../consts/match';
      ...
      case ScoreChange.SCORE:
        ...
        if (this.sportId === Sports.SOCCER) {
          if (
            ...
            console.log('add goal notification');
