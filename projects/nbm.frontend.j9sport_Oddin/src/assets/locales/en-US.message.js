...
export default {
  ...
  market: {
    ...
    11: {
      ...
      /** 首先获得{y}分 */
      '1_0_613': 'Race to {y} Points',
      /** 第1节首先获得{y}分 */
      '1_51_613': 'Q1 Race to {y} Points',
      /** 第2节首先获得{y}分 */
      '1_52_613': 'Q2 Race to {y} Points',
      /** 第3节首先获得{y}分 */
      '1_53_613': 'Q3 Race to {y} Points',
      /** 第4节首先获得{y}分 */
      '1_54_613': 'Q4 Race to {y} Points',
      /** 最后得分球队 */
  ...
  bet: {
    ...
    /** 自动接受所有赔率变化 */
    accept_all: 'Auto Accept All Odds Changes',
    /** 自动接受更高赔率变化 */
    accept_better: 'Auto Accept Better Odds Only',
    /** 请输入投注金额 */
