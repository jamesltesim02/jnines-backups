...
/** 体育列表类型  */
export type SportType = 10 | 11 | 12 | 13 | 14 | 15 | 16 | 99;
/** 比赛列表上的 玩法项类型 */
 ...
 * * 99 - 电竞  
 */
export const AVAILABLE_SPORTS: Array<SportType> = [
  // 足球
  Sports.SOCCER,
  // 篮球
  Sports.BASKETBALL,
...
export const LIST_MARKETS: any = {
  ...
  /** 获取指定体育比赛的列表玩法条件 */
  getMarkets(...sports: Array<SportType>): Array<ListMarket> {
    return uniq(
      sports.map(
        sid => (
          this[sid].map(
