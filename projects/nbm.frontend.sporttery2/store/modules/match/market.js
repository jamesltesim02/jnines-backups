...
const type = types.model(
  'Market',
  {
    ...
    combo: types.maybeNull(types.number),
    /** 是否为主盘 */
    // main: false,
    /** 投注项列表 */
  ...
  onOddsStatusChange (emarket) {
    console.log('odds change:', emarket, JSON.stringify(self.options))
  ...
  onMainGameChange (emarket) {
    console.log('main game change:', emarket, JSON.stringify(self.options))
