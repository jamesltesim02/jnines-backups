...
const OPTION_FORMATERS = {
  ...
  9070: OU_FORMATER,
  /** 赛果/大小 */
  144: betOption => NAMED_BY_OPTION_FORMATER(`144_${betOption}`),
  /** 双胜彩/大小 */
  449: betOption => NAMED_BY_OPTION_FORMATER(`449_${betOption}`),
  /** 两队均得分/双胜彩 */
  451: betOption => NAMED_BY_OPTION_FORMATER(`451_${betOption}`),
  /** 单双/大小 */
  450: betOption => NAMED_BY_OPTION_FORMATER(`450_${betOption}`),
}
