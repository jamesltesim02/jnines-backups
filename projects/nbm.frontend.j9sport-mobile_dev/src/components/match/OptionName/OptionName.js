...
const OPTION_FORMATERS = {
  ...
  9070: OU_FORMATER,
  /** 赛果/大小 */
  144: (betOption, betBar) => OU_FORMATER(`144_${betOption}`, betBar),
  /** 双胜彩/大小 */
  449: (betOption, betBar) => OU_FORMATER(`449_${betOption}`, betBar),
  /** 两队均得分/双胜彩 */
  451: (betOption, betBar) => OU_FORMATER(`451_${betOption}`, betBar),
  /** 单双/大小 */
  450: (betOption, betBar) => OU_FORMATER(`450_${betOption}`, betBar),
}
